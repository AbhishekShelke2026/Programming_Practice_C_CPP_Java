...
int main()
{
    ...
    obj.InsertFirst(51.5656);
    obj.InsertFirst(21.121);
    obj.InsertFirst(11.4545);
    ...
    obj.InsertLast(101.1212);
    obj.InsertLast(121.2323);
    obj.InsertLast(151.4545);
