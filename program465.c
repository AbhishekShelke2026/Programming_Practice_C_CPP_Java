// singlyLL cha Display recursive format madhe kela
// hya madhe Linlklist ulti Display keli
...
void Display(PNODE First)
{
    if(First != NULL)
    {
        Display(First->next);       //Display cha call varti ghetla fakt
        printf("%d\t",First->data);   //mhanun ulti display zali
    }
}
